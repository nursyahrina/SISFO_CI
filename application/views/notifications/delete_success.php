    ...
    <div class="container py-5 mt-5">
    	<div class="alert-container">
	    	<div class="alert alert-light -dark alert-dismissible fade show w-75 m-auto" role="alert">
				<h3 class="alert-heading my-2 text-success font-weight-bold ">Hapus Data <?php echo ($datatype === 'ta') ? 'Tahun Akademik' : ($datatype === 'krs' ? 'KRS' : ucfirst($datatype)) ?> Berhasil!</h3>
				...
				<hr>
				<p class="lead">Data <?php echo ($datatype === 'ta') ? 'tahun akademik' : $datatype ?> berhasil dihapus dari database.</p>
