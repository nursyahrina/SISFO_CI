                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                <!-- <a href="#" class="btn btn-warning shadow-sm" data-toggle="modal" data-target="#cetakMahasiswa"><i class="fas fa-print fa-sm text-white-50"></i> Print</a>
                                <a href="#" class="btn btn-danger shadow-sm mx-2" data-toggle="modal" data-target="#cetakPDFMahasiswa"><i class="fas fa-file fa-sm text-white-50"></i> Cetak PDF</a> -->
                                <a href="#" class="btn btn-primary shadow-sm mx-2" data-toggle="modal" data-target="#addMahasiswa"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <form name="form_edit_mahasiswa" action="<?php echo base_url() . 'mahasiswa/edit' ?>" method="post" class="user needs-validation mx-3 mb-4" novalidate>
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jeniskelamin" pattern="[A-Za-z]{1,10}" required>
                                                <option value=""></option>
                                                <option value="Laki-Laki" <?php if ($mahasiswa->jeniskelamin === 'Laki-Laki') {
                                                                                echo "selected";
                                                                            } ?>>Laki-Laki</option>
                                                <option value="Perempuan" <?php if ($mahasiswa->jeniskelamin === 'Perempuan') {
                                                                                echo "selected";
                                                                            } ?>>Perempuan</option>
                                            </select>
                                            <div class="invalid-feedback">
