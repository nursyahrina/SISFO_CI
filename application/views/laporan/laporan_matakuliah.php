                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex m-3">
                                <a target="blank" href="<?php echo base_url() . 'matakuliah/print/' . set_value('semester') ?>" class="btn btn-warning shadow-sm"><i class="fas fa-print fa-sm text-white-50"></i> Print</a>
                                <a target="blank" href="<?php echo base_url() . 'matakuliah/cetak_pdf/' . set_value('semester') ?>" class="btn btn-danger shadow-sm mx-2"><i class="fas fa-file fa-sm text-white-50"></i> Cetak PDF</a>
                            </div>
