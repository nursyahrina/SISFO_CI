                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="#" class="btn btn-primary shadow-sm" data-toggle="modal" data-target="#addKRS"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ta" pattern="/d{5}" required>
                                            ...
                                            ?>
                                                <option value="<?php echo $tahun_akademik->ta ?>" <?php
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nim" pattern="/d{10}" value="<?php
                                                                                                            foreach ($data_mahasiswa as $mahasiswa) {
                                                                                                                if ($mahasiswa->nim === $krs->nim) {
                                                                                                                    echo $krs->nim . ' ' . $mahasiswa->namamahasiswa;
                                                                                                                }
                                                                                                            }
                                                                                                            ?>" readonly>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mk" pattern="[A-Za-z0-9. ]{1,25}" value="<?php
                                                                                                                        foreach ($data_matakuliah as $matakuliah) {
                                                                                                                            if ($matakuliah->kode_mk === $krs->mk) {
                                                                                                                                echo $krs->mk . ' ' . $matakuliah->nama_mk;
                                                                                                                            }
                                                                                                                        }
                                                                                                                        ?>" readonly>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="nidn" pattern="/d{10}" required>
                                                ...
                                                foreach ($data_dosen as $dosen) {
                                                ?>
                                                    <option value="<?php echo $dosen->nidn ?>" <?php if ($dosen->nidn === $krs->nidn) {
                                                                                                    echo "selected";
                                                                                                } ?>>
                                                        <?php echo $dosen->nidn . ' ' . $dosen->nama_dosen ?>
                                                    </option>
